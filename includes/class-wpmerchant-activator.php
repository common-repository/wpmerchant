...
class Wpmerchant_Activator {
	...
	public static function activate() {
		...
		/**
		DON'T HAVE TO DO THE BELOW BECAUSE WE CREATED CUSTOM POST TYPES FOR PRODUCTS AND PLANS
		$table_name = $wpdb->prefix . "wpmerchant_products"; 
		...
		$table_name = $wpdb->prefix . "wpmerchant_plans"; 
